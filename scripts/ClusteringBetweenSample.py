        ...
        for i in range(len(data)):
            ...
            try:
                if data[i][0] == data[i+1][0] and data[i][2] == data[i+1][2]:
                    ...
                    Pair_Overlap = len(range(max(int(data[i][5]), int(data[i+1][5])), min(int(data[i][6]), int(data[i+1][6]))+OverlapThreshold))
                    Mate_Overlap = len(range(max(int(data[i][7]), int(data[i+1][7])), min(int(data[i][8]), int(data[i+1][8]))+OverlapThreshold))
        ...
        for i in range(len(data)):
            try:
                ...
                if data[i][0] == data[i+1][0]:
                    #Checking for overlaps
                    Pair_Overlap = len(range(max(int(data[i][3]), int(data[i+1][3])), min(int(data[i][4]), int(data[i+1][4]))+OverlapThreshold))
                    if Pair_Overlap > 0:
                        Overlap = True
                    else:
                        Overlap = False
